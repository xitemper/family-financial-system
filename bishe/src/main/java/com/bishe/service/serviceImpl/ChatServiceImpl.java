...
//            saveAssistantMessage(sessionId, aiReply);
    ...
    /** 将助手的回复存入 Redis 并（可选）入库 */
//    private void saveAssistantMessage(String sessionId, String content) {
//        Message assistantMsg = createMessage(Role.ASSISTANT, content);
//        @SuppressWarnings("unchecked")
...
//    }
    ...
    /** 构造并保存本地查询的回复 */
//    private Result buildAndSaveReply(String sessionId, String content) {
//        saveAssistantMessage(sessionId, content);
//        return Result.succeed("查询成功", content);
//    }
